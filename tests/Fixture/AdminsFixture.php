...
class AdminsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'role' => ['type' => 'integer', 'length' => 2, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '0: admin 1:callcenter', 'precision' => null, 'autoIncrement' => null],
    ...
    public $records = [
        [
            ...
            'role' => 1,
            'created' => '2018-03-05 09:59:00',
            'modified' => '2018-03-05 09:59:00'
        ],
    ];
}
